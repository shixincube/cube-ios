...
extern NSString *const CWSSelectedThemeIdentifier;
extern NSString *const CWSThemeIdentifierDefault;
extern NSString *const CWSThemeIdentifierGrapefruit;
extern NSString *const CWSThemeIdentifierGrass;
extern NSString *const CWSThemeIdentifierPinkRose;
extern NSString *const CWSThemeIdentifierDark;

#define CodeFontMake(_pointSize) [UIFont fontWithName:@"Menlo" size:_pointSize]
#define CodeAttributes(_fontSize) @{NSFontAttributeName: CodeFontMake(_fontSize), NSForegroundColorAttributeName: CWSThemeManager.currentTheme.themeCodeColor}

#define IsUITest NSProcessInfo.processInfo.environment[@"isUITest"].boolValue

extern const CGFloat CWSButtonSpacingHeight;

@interface CWSCommonUI : NSObject
+ (void)renderGlobalAppearances;
@end

@interface CWSCommonUI (ThemeColor)
+ (UIColor *)randomThemeColor;
@end

@interface CWSCommonUI (Layer)
